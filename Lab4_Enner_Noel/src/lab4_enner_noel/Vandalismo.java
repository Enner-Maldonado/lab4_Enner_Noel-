...
public class Vandalismo extends Delito_Menor {
    ...
    public Vandalismo(String edificacion, String piso, String nombre_dueño, String name_oficial, String ID, int num_celda, String descripcion, String nombre, String culpable, String sentencia, String fecha, String pais, int num_delitos) {
        super(name_oficial, ID, num_celda, descripcion, nombre, culpable, sentencia, fecha, pais, num_delitos);
